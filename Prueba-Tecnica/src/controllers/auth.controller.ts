...
export const registrarUsuario = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        const [usuarioExistente]: any[] = await db.query('SELECT * FROM usuarios WHERE email = ?', [
            datosUsuario.email
        ]);
 ...
 */
export const obtenerUsuarioAutenticado = async (req: Request, res: Response): Promise<void> => {
    try {
